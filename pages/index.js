    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <p className={styles.description}>
          ...
          <code className={styles.publisher}>Each Card contains a chapter in Matthew's gospel </code>
        </p>
        ...
        <a href="#" className={styles.card}>
          ...
          >
            ...
            <p>
            This card will hold the full content of chapter 25
            </p>
          </a>
          ...
          >
            ...
            <p>
            This card will hold the full content of chapter 26
            </p>
          </a>
          ...
          >
            ...
            <p>
            This card will hold the full content of chapter 27
            </p>
          </a>
          ...
          >
            ...
            <p>
            This card will hold the full content of chapter 28
            </p>
          </a>
        </div>
      </main>
